module Traxor
  ActiveSupport::Notifications.subscribe 'sql.active_record' do |*args|
    ...
    tags = {}
    tags[:active_record_class_name] = Traxor.normalize_name(name.split.first) if name.length.positive?
  ...
  ActiveSupport::Notifications.subscribe 'instantiation.active_record' do |*args|
    ...
    tags = { active_record_class_name: normalize_name(event.payload[:class_name]) }

    Metric.count 'rails.active_record.instantiation.count', record_count, tags
    Metric.count "rails.active_record.instantiation.count.#{tags[:active_record_class_name]}", record_count, tags
  end
end
